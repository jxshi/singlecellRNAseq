...
# CD4/CD8 and γδ marker panels
cd_markers <- convertHumanGeneList(c("CD4", "CD8A", "CD3D", "CD3E", "TRAC", "IL7R", "CD44", "IL2RA", "FOXP3", "CTLA4"))
save_dotplot(sce.sub, cd_markers, paste0(prefix, "_Dotplot_plot.pdf"), width = 5, height = 10)
...
subcelltype <- data.frame(
  ClusterID = 0:14,
  subcelltype = c(
    "CD4_T-proliferating", "CD8_T-proliferating", "CD8_T-proliferating", "CD8_T-proliferating", "CD4_T-proliferating",
    "CD4_T-proliferating", "CD4_T-proliferating", "CD8_T-proliferating", "CD4_T-proliferating", "CD4_T-proliferating",
    "CD8_T-proliferating", "gdT-proliferating", "CD4_T-proliferating", "CD4_T-proliferating", "gdT-proliferating"
  )
)
