# Step 5.4: check B cell subclusters
...
working_dir <- "/home/LiuLab/zzdx/data/singlecell/bgi/wangpengju/xuanyujing/results/3-celltype/Bcells"
setwd(working_dir)
...
assert_file("Bcells.sce.sub.harmony.Rds")
